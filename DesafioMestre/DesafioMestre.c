...
printf("\n");
    ...
    int opcaoPlayer, opcaoPlayer2;
    int vitoria=0, vitoria2=0; /*usarei isso para contar quantas vezes uma carta ganhou
    cada vez que aparecer no switch que uma ganhou vou por "++" para somar 1, no final
    eu comparo para vê qual ganhou mais vezes!!!*/
printf("Escolha duas opções que serão usadas para comparar as cartas, digite seu número para escolhe-las:\n");
printf("1. População\n");
printf("2. Área\n");
printf("3. PIB\n");
...
printf("\n");
printf("Digite o número da primeira opção escolhida: ");
scanf("%d", &opcaoPlayer);
printf("Digite o número da segunda opção escolhida: ");
scanf("%d", &opcaoPlayer2);
printf("\n");

if (opcaoPlayer != opcaoPlayer2){
//OPCAO 1
switch (opcaoPlayer)
{
case 1:
...
printf("Carta 1 - %.2f\n", SuperPoder);
printf("Carta 2 - %.2f\n", SuperPoder2);
SuperPoder > SuperPoder2 ? printf("Carta 1 venceu!\n") : printf("Carta 2 venceu!\n");
printf("\n");
printf("Resultado final:\n");
if (vitoria + SuperPoder > vitoria2 + SuperPoder2){
    printf("Carta 1 venceu!!!\n");
} else {
    printf("Carta 2 venceu!!!\n");
}
