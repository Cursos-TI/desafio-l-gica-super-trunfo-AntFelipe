...
/*tirei a comparação anterior para deixar apenas as comparações com IFs
...
printf("Carta 1 - %s: %u pessoas\n", nome_cidade, populacao); //mostrando o nome da cidade e a quantidade de pessoas
printf("Carta 1 - %s: %u pessoas\n", nome_cidade2, populacao2); //idem
if (populacao>populacao2){ //"se a população1 for maior que a população2:"
...
printf("Carta 1 - %.2f km²\n", area); //mostrando a quantidade de área
printf("Carta 2 - %.2f km²\n", area2); //idem
if (area>area2){ //se area1 for maior que area2:
...
printf("Carta 1 - %.2f\n", PIB); //mostrando o PIB
printf("Carta 2 - %.2f\n", PIB2); //idem
if (PIB>PIB2){ //se PIB1 for maior que PIB2:
    printf("Carta 1 venceu!!!\n");
} else { //se não:
    printf("Carta 2 venceu!!!\n");
}
...
printf("Carta 1 - %d\n", turista); //mostrando a quantidade de pontos turísticos
printf("Carta 2 - %d\n", turista2); //idem
if (turista>turista2) { //se pontos da primeira cidade for maior que o da segunda:
    printf("Carta 1 venceu!!!\n");
} else { //se não:
    printf("Carta 2 venceu!!!");
}
...
printf("Carta 1 - %.2f\n", PIBper); //mostrando o PIBperCapita
printf("Carta 2 - %.2f\n", PIBper2); //idem
if (PIBper>PIBper2){ //se o PIBper1 for maior que o PIBper2 então:
    printf("Carta 1 venceu!!!\n");
} else { //se não:
    printf("Carta 2 venceu!!!\n");
}
...
printf("Carta 1 - %.2f\n", densidade); //mostrando a densidade populacional
printf("Carta 2 - %.2f\n", densidade2); //idem
if (densidade<densidade2){ //se a densidade1 for MENOR que a densidade2 então:
    printf("Carta 1 venceu!!!\n");
} else { //se não:
    printf("Carta 2 venceu!!!\n");
}

/*adicionei aqui as variáveis supers pois é um local onde os valores das outras variaveis já foram postas e aqui
ainda fica organizado*/
...
printf("Carta 1 - %.2f\n", SuperPoder); //mostrando o valor total das somas
printf("Carta 2 - %.2f\n", SuperPoder2); //idem
if (SuperPoder>SuperPoder2){ //se o superpoder da carta 1 for maior então:
    printf("Carta 1 venceu!!!\n");
} else { //se não:
    printf("Carta 2 venceu!!!\n");
}
